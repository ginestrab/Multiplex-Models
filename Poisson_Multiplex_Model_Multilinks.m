...
if (M==2),
    x=tril(rand(N,N));
    y10=tril((ones(N,N)).*(x<(c(1)/N)));
    y11=tril((x>(c(1)/N)).*(x<(c(1)+c(2))/N));
    y01=tril((x>((c(1)+c(2))/N)).*(x<(2*c(1)+c(2))/N));
...
if (M==3),
    ...
    x=tril(rand(N,N));
    y100=tril((ones(N,N)).*(x<(c(1))/N));
    y110=tril((x>(c(1)/N)).*(x<(c(1)+c(2))/N));
    y010=tril((x>(c(1)+c(2))/N).*(x<(2*c(1)+c(2))/N));
    y001=tril((x>(2*c(1)+c(2))/N).*(x<(3*c(1)+c(2))/N));
    y101=tril((x>(3*c(1)+c(2))/N).*(x<(3*c(1)+2*c(2))/N));
    y011=tril((x>(3*c(1)+2*c(2))/N).*(x<(3*c(1)+3*c(2))/N));
    y111=tril((x>(3*c(1)+3*c(2))/N).*(x<(3*c(1)+3*c(2)+c(3))/N));
